...
export default function ModuleLevelMap({
  levels,
  selectedModule,
  onLevelClick,
  onViewChange,
  ...
  return (
    ...
    >
      ...
      >
        {/* Single dropdown showing current module name */}
        <ModuleDropdown
          selectedModule={selectedModule}
          onModuleChange={(id) => onModuleChange?.(id)}
        />
        ...
        >
          <div style={{ fontSize: 11, color: "rgba(255,255,255,0.45)" }}>
            ...
            <span style={{ color: "rgba(255,255,255,0.85)", fontWeight: 600 }}>
              {" "}
              {completedCount} / {levels.length} lessons
            </span>
          </div>
          <div
            style={{
      ...
      >
        ...
        >
          <defs>
            ...
            <radialGradient id="mlGold" cx="50%" cy="50%" r="50%">
          ...
          {levels.map((level, index) => {
            ...
            const r = isCurrent ? 34 : isDone ? 28 : 20;
            ...
            return (
              ...
              >
                ...
                <circle
                  ...
                  fill={bgColor}
                  stroke={ringColor}
                  strokeWidth={isDone || isCurrent ? 2 : 1.5}
                  filter={isDone || isCurrent ? "url(#mlg4)" : ""}
                />
                ...
                {!isDone && (
                  <text
                    ...
                    fontSize={isCurrent ? 18 : isLocked ? 13 : 15}
                    fontWeight="700"
                    fill={numColor}
                    fontFamily="inherit"
                  >
                ...
                <text
                  ...
                  y={pos.y + r + 16}
                  textAnchor="middle"
                  fontSize={isDone || isCurrent ? 12 : 10}
                  fontWeight={isDone || isCurrent ? 600 : 400}
                  fill={labelCol}
                  fontFamily="monospace"
                >
                  {truncate(level.fileName, 22)}
                </text>
              </g>
            );
          })}
